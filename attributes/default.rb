...
default['chefdk']['source'] = "http://omnitruck.chef.io/stable/chefdk/metadata?p=#{node['platform']}&pv=#{node['platform_version']}&m=#{node['kernel']['processor']}&v=#{node['chef-services']['chefdk_version']}"
